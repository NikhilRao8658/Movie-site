  ...
  return (
    <div>
      ...
      <Navbar expand="lg" className="bg-body-tertiary "  >
        <Container fluid >
          <Navbar.Brand href="#">Welcome To TMDB</Navbar.Brand>
          ...
          <Navbar.Collapse id="navbarScroll">
            ...
            >
              ...
              <NavDropdown title="Movies" id="navbarScrollingDropdown">
                <NavDropdown.Item href="#action3"><span>Action Movies</span></NavDropdown.Item>
          ...
          api.map((cards) => {
            ...
            <div >
              ...
              <Card.Body key={cards.id}>
                ...
                <Button variant="primary" onClick={()=>Navigate1("/ParticluarMovie",{state:{cards}})}>Get Details...</Button>
              </Card.Body>
            </Card>
            </div>
            )
